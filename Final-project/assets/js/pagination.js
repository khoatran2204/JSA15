...
async function fetchData(page) {
    const response = await fetch(`https://ecomws.didongviet.vn/fe/v1/products?page=${page}&limit=${pageSize}&category_ids=3&filterParams=sort_by_outstanding&sort_by_outstanding=true`);
